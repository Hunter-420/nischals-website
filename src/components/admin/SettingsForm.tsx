      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50 flex items-center gap-2 flex-shrink-0"
          >
            {resumeUploading ? (
