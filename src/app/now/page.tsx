...
function parseMarkdownLinks(text: string) {
  ...
  while ((match = linkRegex.exec(text)) !== null) {
    ...
    parts.push(
      <a key={lastIndex} href={match[2]} className="text-blue-600 hover:underline font-medium">
        {match[1]}
      </a>
    );
      ...
      <main className="flex-1 mt-8 mb-24 flex flex-col gap-10">
        ...
        {hasContent ? (
          <div className="flex flex-col gap-10">
                    ...
                    <ul className="flex flex-col gap-2">
                      {(section.items as string[])
                        ...
                        .map((item, iIdx) => (
                          <li
                            key={iIdx}
                            className="text-sm text-gray-900 font-normal leading-[1.8] flex items-start gap-2"
                          >
            ...
            {/* Previously Sections */}
            {previous.length > 0 && (
              <div className="flex flex-col gap-8 border-t border-gray-100 pt-10">
            ...
            {content && (
              <div
                className="prose prose-zinc max-w-none text-sm
                  ...
                  prose-p:text-gray-900 prose-p:font-normal prose-p:leading-[1.8]
