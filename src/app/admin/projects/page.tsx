        ...
        <table className="min-w-[640px] w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider sm:px-6">Featured</th>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            ...
            {projects.length === 0 && (
              <tr>
                <td colSpan={3} className="px-4 py-12 text-center text-gray-500 sm:px-6">
